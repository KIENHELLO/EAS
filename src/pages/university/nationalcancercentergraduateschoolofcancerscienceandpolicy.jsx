...
export const ssgOptions = {
  slug: 'university/nationalcancercentergraduateschoolofcancerscienceandpolicy',
  routeUrl: '/university/nationalcancercentergraduateschoolofcancerscienceandpolicy',
  Head: () => (
    <>
      ...
      <script type="application/ld+json">
        {`{
          ...
          "name": "Học viện Sau ĐH Ung thư Quốc tế - TT Ung thư QG",
          "alternateName": "National Cancer Center Graduate School of Cancer Science and Policy",
          "url": "",
          "address": {
            "@type": "PostalAddress",
            "addressCountry": "KR",
  ...
  context: async (children) => {
    ...
    return <StaticRouter location="/university/nationalcancercentergraduateschoolofcancerscienceandpolicy">{children}</StaticRouter>;
  }
};

export default function UniversityDetailPage() {
  return <Island component="components/UniversityDetailApp" props={{ schoolId: 'nationalcancercentergraduateschoolofcancerscienceandpolicy' }} />;
}
