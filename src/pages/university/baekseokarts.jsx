...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường CĐ Nghệ thuật Baekseok (Baekseok Arts University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #350." />
      ...
      <meta property="og:description" content="Học phí trường CĐ Nghệ thuật Baekseok (Baekseok Arts University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #350." />
      ...
      <meta name="twitter:description" content="Học phí trường CĐ Nghệ thuật Baekseok (Baekseok Arts University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #350." />
