...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường ĐH Công nghệ Hàn Quốc (Tech University of Korea): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #405." />
      ...
      <meta property="og:description" content="Học phí trường ĐH Công nghệ Hàn Quốc (Tech University of Korea): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #405." />
      ...
      <meta name="twitter:description" content="Học phí trường ĐH Công nghệ Hàn Quốc (Tech University of Korea): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #405." />
