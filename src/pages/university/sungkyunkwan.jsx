...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường ĐH Sungkyunkwan (CS KHTN) (Sungkyunkwan University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #391." />
      ...
      <meta property="og:description" content="Học phí trường ĐH Sungkyunkwan (CS KHTN) (Sungkyunkwan University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #391." />
      ...
      <meta name="twitter:description" content="Học phí trường ĐH Sungkyunkwan (CS KHTN) (Sungkyunkwan University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #391." />
