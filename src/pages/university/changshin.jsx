...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Đại học Changshin (Changshin University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #518." />
      ...
      <meta property="og:description" content="Học phí trường Đại học Changshin (Changshin University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #518." />
      ...
      <meta name="twitter:description" content="Học phí trường Đại học Changshin (Changshin University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #518." />
