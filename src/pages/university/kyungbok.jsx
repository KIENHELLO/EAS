...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường CĐ Kyungbok (Kyungbok University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #427." />
      ...
      <meta property="og:description" content="Học phí trường CĐ Kyungbok (Kyungbok University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #427." />
      ...
      <meta name="twitter:description" content="Học phí trường CĐ Kyungbok (Kyungbok University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #427." />
