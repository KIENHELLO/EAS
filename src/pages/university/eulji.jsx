...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường ĐH Eulji (CS Uijeongbu/Seongnam) (Eulji University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #399." />
      ...
      <meta property="og:description" content="Học phí trường ĐH Eulji (CS Uijeongbu/Seongnam) (Eulji University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #399." />
      ...
      <meta name="twitter:description" content="Học phí trường ĐH Eulji (CS Uijeongbu/Seongnam) (Eulji University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #399." />
