...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Cao đẳng Jeonju Vision (Jeonju Vision College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Jeonbuk. Xếp hạng: #613." />
      ...
      <meta property="og:description" content="Học phí trường Cao đẳng Jeonju Vision (Jeonju Vision College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Jeonbuk. Xếp hạng: #613." />
      ...
      <meta name="twitter:description" content="Học phí trường Cao đẳng Jeonju Vision (Jeonju Vision College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Jeonbuk. Xếp hạng: #613." />
