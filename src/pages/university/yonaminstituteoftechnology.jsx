...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Cao đẳng Công nghệ Yonam (Yonam Institute of Technology): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #588." />
      ...
      <meta property="og:description" content="Học phí trường Cao đẳng Công nghệ Yonam (Yonam Institute of Technology): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #588." />
      ...
      <meta name="twitter:description" content="Học phí trường Cao đẳng Công nghệ Yonam (Yonam Institute of Technology): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #588." />
