...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường ĐH Seokyeong (Seokyeong University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #313." />
      ...
      <meta property="og:description" content="Học phí trường ĐH Seokyeong (Seokyeong University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #313." />
      ...
      <meta name="twitter:description" content="Học phí trường ĐH Seokyeong (Seokyeong University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #313." />
