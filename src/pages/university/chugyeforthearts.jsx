...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường ĐH Nghệ thuật Chugye (Chugye University for the Arts): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #325." />
      ...
      <meta property="og:description" content="Học phí trường ĐH Nghệ thuật Chugye (Chugye University for the Arts): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #325." />
      ...
      <meta name="twitter:description" content="Học phí trường ĐH Nghệ thuật Chugye (Chugye University for the Arts): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #325." />
