...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Viện Khoa học & Công nghệ Ulsan (UNIST) (UNIST): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Ulsan. Xếp hạng: #624." />
      ...
      <meta property="og:description" content="Học phí trường Viện Khoa học & Công nghệ Ulsan (UNIST) (UNIST): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Ulsan. Xếp hạng: #624." />
      ...
      <meta name="twitter:description" content="Học phí trường Viện Khoa học & Công nghệ Ulsan (UNIST) (UNIST): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Ulsan. Xếp hạng: #624." />
