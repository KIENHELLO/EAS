...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Cao đẳng Y tế Jinju (Jinju Health College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #586." />
      ...
      <meta property="og:description" content="Học phí trường Cao đẳng Y tế Jinju (Jinju Health College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #586." />
      ...
      <meta name="twitter:description" content="Học phí trường Cao đẳng Y tế Jinju (Jinju Health College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #586." />
