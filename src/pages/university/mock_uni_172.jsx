...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Đại học Kookmin (Kookmin University): 2,149,000 - 4,390,000 KRW (39,756,500 - 81,215,000 VND) mỗi học kỳ. Địa chỉ: 경상홀(UIT), 정릉로, 정릉동, 정릉3동, 성북구, 서울특별시, 02812, 대한민국. Xếp hạng: #195." />
      ...
      <meta property="og:description" content="Học phí trường Đại học Kookmin (Kookmin University): 2,149,000 - 4,390,000 KRW (39,756,500 - 81,215,000 VND) mỗi học kỳ. Địa chỉ: 경상홀(UIT), 정릉로, 정릉동, 정릉3동, 성북구, 서울특별시, 02812, 대한민국. Xếp hạng: #195." />
      ...
      <meta name="twitter:description" content="Học phí trường Đại học Kookmin (Kookmin University): 2,149,000 - 4,390,000 KRW (39,756,500 - 81,215,000 VND) mỗi học kỳ. Địa chỉ: 경상홀(UIT), 정릉로, 정릉동, 정릉3동, 성북구, 서울특별시, 02812, 대한민국. Xếp hạng: #195." />
