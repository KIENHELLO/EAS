...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Học viện Sau ĐH Thần học Torch Trinity (Torch Trinity Graduate University of Theology): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #374." />
      ...
      <meta property="og:description" content="Học phí trường Học viện Sau ĐH Thần học Torch Trinity (Torch Trinity Graduate University of Theology): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #374." />
      ...
      <meta name="twitter:description" content="Học phí trường Học viện Sau ĐH Thần học Torch Trinity (Torch Trinity Graduate University of Theology): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #374." />
