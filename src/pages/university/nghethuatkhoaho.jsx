...
export const ssgOptions = {
  slug: 'university/nghethuatkhoaho',
  ...
  context: async (children) => {
    ...
    return <StaticRouter location="/university/nghethuatkhoaho">{children}</StaticRouter>;
  }
};

export default function UniversityDetailPage() {
  return <Island component="components/UniversityDetailApp" props={{ schoolId: 'nghethuatkhoaho' }} />;
}
