...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường CĐ Polytech II (Incheon) (Korea Polytechnic II College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Incheon. Xếp hạng: #462." />
      ...
      <meta property="og:description" content="Học phí trường CĐ Polytech II (Incheon) (Korea Polytechnic II College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Incheon. Xếp hạng: #462." />
      ...
      <meta name="twitter:description" content="Học phí trường CĐ Polytech II (Incheon) (Korea Polytechnic II College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Incheon. Xếp hạng: #462." />
