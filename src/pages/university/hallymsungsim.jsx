...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Cao đẳng Hallym Sungsim (Hallym Sungsim University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gangwon. Xếp hạng: #614." />
      ...
      <meta property="og:description" content="Học phí trường Cao đẳng Hallym Sungsim (Hallym Sungsim University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gangwon. Xếp hạng: #614." />
      ...
      <meta name="twitter:description" content="Học phí trường Cao đẳng Hallym Sungsim (Hallym Sungsim University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gangwon. Xếp hạng: #614." />
