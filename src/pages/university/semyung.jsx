...
export const ssgOptions = {
  slug: 'university/semyung',
  routeUrl: '/university/semyung',
  Head: () => (
    <>
  ...
  context: async (children) => {
    ...
    return <StaticRouter location="/university/semyung">{children}</StaticRouter>;
  }
};

export default function UniversityDetailPage() {
  return <Island component="components/UniversityDetailApp" props={{ schoolId: 'semyung' }} />;
}
