...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường CĐ Công nghiệp Inha (Inha Technical College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Incheon. Xếp hạng: #457." />
      ...
      <meta property="og:description" content="Học phí trường CĐ Công nghiệp Inha (Inha Technical College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Incheon. Xếp hạng: #457." />
      ...
      <meta name="twitter:description" content="Học phí trường CĐ Công nghiệp Inha (Inha Technical College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Incheon. Xếp hạng: #457." />
