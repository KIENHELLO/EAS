...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường ĐH Quốc gia Incheon (Incheon National University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Incheon. Xếp hạng: #418." />
      ...
      <meta property="og:description" content="Học phí trường ĐH Quốc gia Incheon (Incheon National University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Incheon. Xếp hạng: #418." />
      ...
      <meta name="twitter:description" content="Học phí trường ĐH Quốc gia Incheon (Incheon National University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Incheon. Xếp hạng: #418." />
