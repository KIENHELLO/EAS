...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Đại học Chungwoon (Chungwoon University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Chungnam. Xếp hạng: #571." />
      ...
      <meta property="og:description" content="Học phí trường Đại học Chungwoon (Chungwoon University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Chungnam. Xếp hạng: #571." />
      ...
      <meta name="twitter:description" content="Học phí trường Đại học Chungwoon (Chungwoon University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Chungnam. Xếp hạng: #571." />
