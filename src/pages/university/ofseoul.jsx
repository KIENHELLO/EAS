...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường ĐH Thị lập Seoul (University of Seoul): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #316." />
      ...
      <meta property="og:description" content="Học phí trường ĐH Thị lập Seoul (University of Seoul): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #316." />
      ...
      <meta name="twitter:description" content="Học phí trường ĐH Thị lập Seoul (University of Seoul): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Seoul. Xếp hạng: #316." />
