...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Đại học Cyber Taegu (Daegu Cyber University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongbuk. Xếp hạng: #576." />
      ...
      <meta property="og:description" content="Học phí trường Đại học Cyber Taegu (Daegu Cyber University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongbuk. Xếp hạng: #576." />
      ...
      <meta name="twitter:description" content="Học phí trường Đại học Cyber Taegu (Daegu Cyber University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongbuk. Xếp hạng: #576." />
