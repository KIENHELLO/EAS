...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Cao đẳng Polytech VII Changwon (Korea Polytech VII (Changwon)): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #623." />
      ...
      <meta property="og:description" content="Học phí trường Cao đẳng Polytech VII Changwon (Korea Polytech VII (Changwon)): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #623." />
      ...
      <meta name="twitter:description" content="Học phí trường Cao đẳng Polytech VII Changwon (Korea Polytech VII (Changwon)): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeongnam. Xếp hạng: #623." />
