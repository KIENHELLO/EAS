...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường CĐ Polytech II (Hwaseong) (Korea Polytechnic II College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #461." />
      ...
      <meta property="og:description" content="Học phí trường CĐ Polytech II (Hwaseong) (Korea Polytechnic II College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #461." />
      ...
      <meta name="twitter:description" content="Học phí trường CĐ Polytech II (Hwaseong) (Korea Polytechnic II College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #461." />
