...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường CĐ Du lịch Hàn Quốc (Korea Tourism College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #455." />
      ...
      <meta property="og:description" content="Học phí trường CĐ Du lịch Hàn Quốc (Korea Tourism College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #455." />
      ...
      <meta name="twitter:description" content="Học phí trường CĐ Du lịch Hàn Quốc (Korea Tourism College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Gyeonggi. Xếp hạng: #455." />
