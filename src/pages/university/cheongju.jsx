...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Đại học Cheongju (Cheongju University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Chungbuk. Xếp hạng: #537." />
      ...
      <meta property="og:description" content="Học phí trường Đại học Cheongju (Cheongju University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Chungbuk. Xếp hạng: #537." />
      ...
      <meta name="twitter:description" content="Học phí trường Đại học Cheongju (Cheongju University): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Chungbuk. Xếp hạng: #537." />
