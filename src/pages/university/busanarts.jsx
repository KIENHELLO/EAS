...
export const ssgOptions = {
  ...
  Head: () => (
    <>
      ...
      <meta name="description" content="Học phí trường Cao đẳng Nghệ thuật Busan (Busan Arts College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Busan. Xếp hạng: #582." />
      ...
      <meta property="og:description" content="Học phí trường Cao đẳng Nghệ thuật Busan (Busan Arts College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Busan. Xếp hạng: #582." />
      ...
      <meta name="twitter:description" content="Học phí trường Cao đẳng Nghệ thuật Busan (Busan Arts College): 0 KRW (0 VND) mỗi học kỳ. Địa chỉ: Busan. Xếp hạng: #582." />
